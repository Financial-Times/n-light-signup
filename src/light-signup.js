export default {
	...
	init() {
		...
		const responseMsg = {
			...
			'USER_NOT_ANONYMOUS': `It looks like you already have an account with us. <a target="_blank" href="/login?location=${pageLocation}" style="text-decoration:none;color:#27757B;">Sign in</a>.`
		};
