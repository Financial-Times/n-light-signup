export default `<div class='n-light-signup' data-trackable="light-signup">
	<div class="n-light-signup__inner">
		<div class="n-light-signup__close"></div>
		<h2 class="n-light-signup__heading">Get a taste of the FT</h2>
		<p class="n-light-signup__tagline">Sample the FT, with the top stories sent FREE to your inbox every morning.</p>
		<p class="n-light-signup__text">For 1 week, you’ll get an email with free access to the 3 most read FT stories.</p>
